package claro.com.pe.carga.datos.replica.cambio.plan;

import claro.com.pe.carga.datos.replica.cambio.plan.service.MainService;
...
public class MainClass{
    ...
    public static void main( String[] args ){
        ...
        try{
            ...
            result=mainClass.launch(idTransaction,pi_fec_proc);
    ...
    public int launch(String idTransaction, String pi_fec_proc){
        ...
        try{
            mainService.runReplicambioPlanHist(idTransaction,pi_fec_proc);
        } catch (Exception e){
