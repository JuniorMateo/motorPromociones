package claro.com.pe.evalua.bono.recalculo.handler;
...
import claro.com.pe.evalua.bono.recalculo.security.Security;
import claro.com.pe.evalua.bono.recalculo.security.UsernameToken;


public class BssProductOrderingManzgementClientHandler  implements SOAPHandler<SOAPMessageContext>{

	
	private final Logger LOGGER = Logger.getLogger(BssProductOrderingManzgementClientHandler.class);

	private String				username;
	private String				password;

	public BssProductOrderingManzgementClientHandler(){
		super();
	}

	public BssProductOrderingManzgementClientHandler( String username, String password ){
		super();
