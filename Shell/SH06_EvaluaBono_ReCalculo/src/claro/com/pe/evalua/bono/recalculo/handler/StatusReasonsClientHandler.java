...
public class StatusReasonsClientHandler implements SOAPHandler<SOAPMessageContext>{

	private final Logger LOGGER = Logger.getLogger(StatusReasonsClientHandler.class);

	private String				username;
	private String				password;

	public StatusReasonsClientHandler(){
		super();
	}

	public StatusReasonsClientHandler( String username, String password ){
		super();
