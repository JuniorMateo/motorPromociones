package claro.com.pe.bajacontrato.util;
...
public class PropertiesExternos {
	 ...
	 @Value("${log4j.dir}") public String LOG4J_DIR; 
		...
		@Value("${bscs.promss.desactiva.baja.contrato}")public String BSCS_DESACTIVACIONBAJACONTRATO;
	 ...
	 // WS INT-COP-0223
		...
		@Value( "${baja.contrato.desactivo}" )  public String desactivo;
		@Value( "${baja.contrato.activo}" )  public String activo;
